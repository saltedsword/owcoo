...
module.exports={
  ...
  development: {
     mongo: {
        // uri: 'mongodb://192.168.1.104:27017/test'
        uri: 'mongodb://localhost:27017/cms'
      },
     port: '8080',
     qiniu: {  // 七牛云sdk配置 (仅供参考)
       ACCESS_KEY: 'prdiyu09OzUHVz8N37ifE848PU16a8xPlODMf7sA',   // 示例：'SVDBGFNHBFSBFDNGSBRSVFDV'
       SECRET_KEY: 'ys3IlT0IOofca9BWVr3HOhDNyFAzZGgyFyvxDu5B',   // 示例：'XVDFNBDNTWGECdterfnfdvac345edfv'
       bucket: 'mycms',          // 示例: 'sinn'
       baseUrl: "http://oues8l8zv.bkt.clouddn.com/",
     },
  ...
  production: {
    mongo: {
        uri: 'mongodb://192.168.1.104:27017/cms'
      },
     port: '8080',
     qiniu: { // 七牛云sdk配置 (仅供参考)
       ACCESS_KEY: '授权key',
